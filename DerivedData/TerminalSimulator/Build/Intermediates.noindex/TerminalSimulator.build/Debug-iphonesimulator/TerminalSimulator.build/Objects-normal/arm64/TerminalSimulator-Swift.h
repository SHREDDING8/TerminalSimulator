...
#ifndef TERMINALSIMULATOR_SWIFT_H
#define TERMINALSIMULATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TerminalSimulator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17TerminalSimulator11AppDelegate")
...
SWIFT_CLASS("_TtC17TerminalSimulator13SceneDelegate")
...
SWIFT_CLASS("_TtC17TerminalSimulator22TerminalViewController")
@interface TerminalViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified fieldView;
...
@interface TerminalViewController (SWIFT_EXTENSION(TerminalSimulator)) <UIColorPickerViewControllerDelegate>
...
@interface TerminalViewController (SWIFT_EXTENSION(TerminalSimulator))
- (void)keyboardWillHideWithNotification:(NSNotification * _Nonnull)notification;
@end


@interface TerminalViewController (SWIFT_EXTENSION(TerminalSimulator)) <UITextViewDelegate>
- (void)textViewDidChange:(UITextView * _Nonnull)textView;
- (void)tapGetPrevCommand;
- (void)tapGetNextCommand;
@end
...
@interface UITextView (SWIFT_EXTENSION(TerminalSimulator))
